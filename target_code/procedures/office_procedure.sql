-- Goal is to make a procedure that is called gets an office from the table 
...
CREATE OR REPLACE PROCEDURE ud_cisc637_group1_target.insert_or_get_office(
